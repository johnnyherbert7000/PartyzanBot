...
public class Utils {
	...
	public static String convertToPrivateAutoNumberWithRegion(String registration) {
		return registration.substring(0, 4).concat(" ")
				.concat(registration.substring(4, 6).concat("-").concat(registration.substring(6, 7)));
	}
	...
	public static String convertToAutoNumberWithRegion(String registration) {
		return registration.substring(0, 2).concat(" ")
				.concat(registration.substring(2, 6).concat("-").concat(registration.substring(6, 7)));
	}
